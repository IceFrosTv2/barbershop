...
!function (a) {
  ...
  k.prototype = {
    ...
    place: function () {
      ...
      var b = this.picker.outerWidth(), c = this.picker.outerHeight(),
        d = a(this.o.container), e = d.width(),
    ...
    getClassNames: function (b) {
      var c = [], f = this.viewDate.getUTCFullYear(),
        g = this.viewDate.getUTCMonth(), h = d();
    ...
    fill: function () {
      var e, f, g = new Date(this.viewDate), h = g.getUTCFullYear(),
        i = g.getUTCMonth(),
    ...
    updateNavArrows: function () {
      if (this._allow_update) {
        var a, b, c = new Date(this.viewDate), d = c.getUTCFullYear(),
          e = c.getUTCMonth(),
  ...
  l.prototype = {
    ...
    dateUpdated: function (c) {
      if (!this.updating) {
        ...
        if (d !== b) {
          var e = d.getUTCDate(), f = this.keepEmptyValues,
            g = a.inArray(c.target, this.inputs), h = g - 1, i = g + 1,
  ...
  var q = a.fn.datepicker.dates = {
    ...
    parseDate: function (c, e, f, g) {
      ...
      var t, u, v = {}, w = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"],
        x = {
          yyyy: function (a, b) {
